...
${this.wrapWithColor(
  "   Building efficient, reliable software with Java, Spring",
  "#ffffff"
)}
${this.wrapWithColor("   Boot, React, and TypeScript", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Clean architecture, problem solving, and continuously",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Strong team player with great communication, time",
  "#ffffff"
)}
${this.wrapWithColor("   management, and project planning skills", "#ffffff")}
...
<span style="color: #00ffff;">GREGGS | Retail Assistant</span>
${this.wrapWithColor(
  "Apr 2024 - Present | Cambridge, UK",
  "#ffffff"
)}

• ${this.wrapWithColor("Customer service", "#ffa07a")} - ${this.wrapWithColor(
      "Delivered friendly, efficient service in a fast-paced retail environment.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Teamwork", "#ffa07a")} - ${this.wrapWithColor(
      "Worked collaboratively with colleagues to keep operations running smoothly.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Time management", "#ffa07a")} - ${this.wrapWithColor(
      "Balanced work alongside full-time studies.",
      "#ffffff"
    )}

<span style="color: #00ffff;">TVS MOTORS | IT and System Support Intern</span>
${this.wrapWithColor(
  "Jun 2022 – Aug 2022 | Karaikal, Pondicherry, India",
  "#ffffff"
)}

• ${this.wrapWithColor("System support", "#ffa07a")} - ${this.wrapWithColor(
      "Assisted with IT infrastructure and system maintenance tasks.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Troubleshooting", "#ffa07a")} - ${this.wrapWithColor(
      "Helped diagnose and resolve hardware and software issues.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hands-on exposure", "#ffa07a")} - ${this.wrapWithColor(
      "Gained practical experience with real-world IT systems.",
      "#ffffff"
    )}`;
...
• ${this.wrapWithColor("Spring Boot", "#ffffff")}
...
• ${this.wrapWithColor("React Native", "#ffffff")}
• ${this.wrapWithColor("Next JS", "#ffffff")}
• ${this.wrapWithColor("Tailwind", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:subhasreebabu11.b@gmail.com" style="color: #ffffff; text-decoration: none;">subhasreebabu11.b@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://bunnybear97.github.io/Blank/" target="_blank" style="color: #ffffff; text-decoration: none;">bunnybear97.github.io/Blank</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="tel:+447717665409" style="color: #ffffff; text-decoration: none;">+44 7717 665409</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="#" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/subhasreebabu</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "EasyFind",
        description: "Local Professional Discovery Application - full-stack web app with radius-based search connecting users to local professionals",
        technologies: ["React", "Node.js", "MySQL", "REST API"],
      },
      {
        title: "Together Culture",
        description: "University team project (1st rank) - full-stack web application for Together Culture",
        technologies: ["JavaScript", "Node", "REST APIs", "MySQL", "Git"],
      },
    ];
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "subhasree@babu: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "bunnybear97.github.io/Blank";
