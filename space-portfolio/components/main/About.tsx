            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <div
                                className="flex items-center justify-center bg-[#0300145e] text-white font-bold"
                                style={{ width: 250, height: 250, fontSize: "4rem" }}
                            >
                                SB
                            </div>
                        </motion.div>
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                ...
                                Anglia Ruskin University, Cambridge UK, and a
                                passionate Full-Stack Developer with expertise
                                in Java, Spring Boot, React, TypeScript, and
                                Python. I love building efficient, reliable
                                software and have hands-on experience from
                                projects like EasyFind and Together Culture, as
                                well as an IT support internship at TVS Motors.
                                I&apos;m passionate about clean architecture,
                                problem solving, and continuously learning new
                                technologies, and I&apos;m keen to connect with
                                like-minded developers to explore new
                                opportunities.
                            </h1>
                        </motion.div>
                    )}
