...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "GREGGS",
    description: [
      "Delivered friendly, efficient customer service in a fast-paced retail environment.",
      "Worked collaboratively with colleagues to keep daily operations running smoothly.",
      "Balanced work alongside full-time Computer Science studies.",
    ],
    skills: [],
  },
  {
